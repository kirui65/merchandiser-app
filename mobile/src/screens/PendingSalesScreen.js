...
export default function PendingSalesScreen() {
  ...
  const [sales, setSales] = useState([]); const [retrying, setRetrying] = useState(null); const [refreshing, setRefreshing] = useState(false);
