...
const createStyles = (colors) => StyleSheet.create({ container: { flex: 1, backgroundColor: colors.background }, header: { padding: spacing.lg, paddingBottom: spacing.sm }, eyebrow: { color: colors.primary, fontSize: 11, fontWeight: '800', letterSpacing: 1.2 }, titleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: spacing.md, marginTop: spacing.xs }, title: { color: colors.ink, fontSize: typography.title, fontWeight: '800' }, exportButton: { backgroundColor: colors.primarySoft, borderRadius: 10, paddingHorizontal: spacing.sm, paddingVertical: spacing.xs }, exportDisabled: { opacity: 0.5 }, exportPressed: { opacity: 0.75 }, exportText: { color: colors.primaryDark, fontSize: typography.small, fontWeight: '800' }, subtitle: { color: colors.muted, fontSize: typography.small, marginTop: spacing.xs }, list: { flexGrow: 1, padding: spacing.lg, paddingTop: spacing.sm }, card: { marginBottom: spacing.md }, row: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: spacing.md }, product: { color: colors.ink, fontSize: typography.h3, fontWeight: '800' }, date: { color: colors.muted, fontSize: 12, marginTop: 4 }, qty: { color: colors.muted, fontSize: typography.small, marginTop: spacing.md }, total: { color: colors.primary, fontSize: 18, fontWeight: '800', marginTop: spacing.md } });
