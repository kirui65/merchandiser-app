...
const styles = StyleSheet.create({ group: { marginBottom: spacing.md }, label: { color: colors.ink, fontSize: typography.small, fontWeight: '700', marginBottom: spacing.xs }, shell: { minHeight: 52, flexDirection: 'row', alignItems: 'center', paddingHorizontal: spacing.md, borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, backgroundColor: colors.surface }, icon: { width: 24, color: colors.primary, fontSize: 17 }, input: { flex: 1, color: colors.ink, fontSize: typography.body, paddingVertical: 0 } });
