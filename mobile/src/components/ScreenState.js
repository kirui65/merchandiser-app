...
const styles = StyleSheet.create({ center: { flex: 1, padding: spacing.lg, alignItems: 'center', justifyContent: 'center', gap: spacing.md }, text: { fontFamily: typography.fontFamily, fontSize: typography.small } });
